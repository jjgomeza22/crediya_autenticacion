...
public class GlobalExceptionHandler extends AbstractErrorWebExceptionHandler {
    ...
    private final BiFunction<Throwable, ServerRequest, Mono<ServerResponse>> handleDuplicateEmail =
            (ex, req) -> handleException((DuplicateEmailException) ex, req);
    ...
    private final BiFunction<Throwable, ServerRequest, Mono<ServerResponse>> handleInvalidCredentials =
            (ex, req) -> handleException((InvalidCredentialsException) ex, req);
    ...
    private final Map<Class<? extends Throwable>, BiFunction<Throwable, ServerRequest, Mono<ServerResponse>>> EXCEPTION_HANDLERS = Map.of(
            ...
            DuplicateEmailException.class, handleDuplicateEmail,
            InvalidAuthException.class, handleInvalidAuth,
            InvalidCredentialsException.class, handleInvalidCredentials
    );
    ...
    private Mono<ServerResponse> handleException(InvalidInputException ex, ServerRequest request) {
        return handleException(HttpStatus.BAD_REQUEST, ex, request, problemDetail -> problemDetail.setTitle("Invalid Input"));
    }

    private Mono<ServerResponse> handleException(DuplicateEmailException ex, ServerRequest request) {
    ...
    private Mono<ServerResponse> handleException(InvalidCredentialsException ex, ServerRequest request) {
